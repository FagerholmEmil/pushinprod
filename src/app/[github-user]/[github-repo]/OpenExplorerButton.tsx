...
export const OpenExplorerButton: React.FC<OpenExplorerButtonProps> = ({}) => {
  ...
  return (
    ...
    >
      Search files
      <kbd className="pointer-events-none absolute right-[0.3rem] top-[0.3rem] hidden h-5 select-none rounded border bg-muted px-1.5 font-mono text-[10px] font-medium opacity-100 sm:flex sm:items-center">
